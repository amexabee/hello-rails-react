...
Hello Rails React is a web application that utilizes both React and Ruby on Rails to display a random greeting message.
...
```
  git clone https://github.com/amexabee/hello-rails-react.git
```
